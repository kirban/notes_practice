...
<div class="zametka">
    <div class="row heading">
        ...
        <form action="../controller/change.php" method="post" class="form-horizontal col-md-offset-1 col-lg-offset-1 col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h4>Заголовок:</h4><div class="setTitle form-group"><h3><input type="text" class="col-xs-12 col-sm-12 col-md-12 col-lg-8" value="$note_title" name="new_title"></h3></div>
            <h4>Текст:</h4><div class="setText form-group" > <textarea class="col-xs-12 col-sm-12 col-md-12 col-lg-8" rows="9" name="new_text">$note_text</textarea></div>
